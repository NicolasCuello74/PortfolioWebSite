        ...
        <div className='container mx-auto h-20 flex items-center justify-between px-8 lg:px-10 xl:px-14'>
          ...
          <div id='header-nav' className={`${isOpen ? 'block' : 'hidden'} lg:inline-block`}>
            <ul className="text-center z-10 absolute w-full py-4 space-y-2 top-20 bg-themecolor/90 left-0 lg:static lg:bg-transparent lg:py-0 lg:space-y-0 lg:align-middle lg:space-x-4 lg:text-[17px]">
              ...
              <li className='list-none block w-full lg:inline-block lg:w-auto'>
                <a href="#Educations" className='relative lg:before:absolute lg:before:-bottom-1 lg:before:left-0 lg:before:right-0 lg:before:h-px lg:before:bg-black lg:hover:before:w-full lg:before:animate-lineOut lg:hover:before:animate-lineIn'>Educations</a>
              </li>
              <li className='list-none block w-full lg:inline-block lg:w-auto'>
              ...
              <li className='list-none block w-full lg:inline-block lg:w-auto'>
                <a href="#Skills" className='relative lg:before:absolute lg:before:-bottom-1 lg:before:left-0 lg:before:right-0 lg:before:h-px lg:before:bg-black lg:hover:before:w-full lg:before:animate-lineOut lg:hover:before:animate-lineIn'>Skills</a>
              </li>
